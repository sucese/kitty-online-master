 ...
 * @author guoxiaoxing
 */
public class UserTweet extends BaseObject implements Parcelable {
    ...
    public static final Parcelable.Creator<UserTweet> CREATOR = new Creator<UserTweet>() {
