 ...
 */
public abstract class BeamListFragment<T extends BeamListFragmentBasePresenter, M> extends BeamFragment<T> {
    View mRootView;
    private ListConfig mListConfig;
    private EasyRecyclerView mListView;
    private BeamListFragmentBasePresenter.DataAdapter mAdapter;
