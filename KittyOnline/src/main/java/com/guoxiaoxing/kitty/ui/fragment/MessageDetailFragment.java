...
import com.guoxiaoxing.kitty.model.MessageDetail;
import com.guoxiaoxing.kitty.model.MessageDetailList;
...
public class MessageDetailFragment extends BaseListFragment<MessageDetail> implements
    ...
    private void handleShowDate(List<MessageDetail> list) {
        ...
        for (int i = list.size() - 1; i >= 0; i--) {
            msg = list.get(i);
            Date date = com.guoxiaoxing.kitty.util.StringUtils.toDate(msg.getPubDate());
