package com.guoxiaoxing.kitty.ui.expansion.list;
...
import com.guoxiaoxing.kitty.util.Utils;
 ...
 */
public abstract class BeamListActivity<T extends BeamListActivityBasePresenter, M> extends BeamBaseActivity<T> {

    private ListConfig mListConfig;
    private EasyRecyclerView mListView;
    private BeamListActivityBasePresenter.DataAdapter mAdapter;
