...
import com.guoxiaoxing.kitty.tmp.DragAdatper.MainViewHolder;
...
public class DragAdatper extends DragSortAdapter<MainViewHolder> {
    ...
    public MainViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.home_item_content, parent, false);
...
//        holder.container.postInvalidate();
    ...
    static class MainViewHolder extends ViewHolder implements
