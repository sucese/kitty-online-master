package com.guoxiaoxing.kitty.tmp;
...
import com.guoxiaoxing.kitty.tmp.modules.FastBinding;
...
public class CustomSwipeToRefreshRefreshActivity extends AppCompatActivity implements ActionMode.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ultimateRecyclerView.setParallaxHeader(getLayoutInflater().inflate(R.layout.common_recyclerview_header, ultimateRecyclerView.mRecyclerView, false));
