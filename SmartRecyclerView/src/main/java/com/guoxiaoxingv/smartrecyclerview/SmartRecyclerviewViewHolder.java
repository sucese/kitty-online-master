...
import com.guoxiaoxingv.smartrecyclerview.itemTouchHelper.ItemTouchHelperViewHolder;
 ...
 */
public class SmartRecyclerviewViewHolder extends RecyclerView.ViewHolder implements
    ...
    public SmartRecyclerviewViewHolder(View itemView) {
        super(itemView);
