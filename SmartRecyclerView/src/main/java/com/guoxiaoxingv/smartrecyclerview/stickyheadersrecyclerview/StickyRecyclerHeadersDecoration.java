package com.guoxiaoxingv.smartrecyclerview.stickyheadersrecyclerview;
...
import com.guoxiaoxingv.smartrecyclerview.stickyheadersrecyclerview.caching.HeaderProvider;
import com.guoxiaoxingv.smartrecyclerview.stickyheadersrecyclerview.caching.HeaderViewCache;
import com.guoxiaoxingv.smartrecyclerview.stickyheadersrecyclerview.calculation.DimensionCalculator;
import com.guoxiaoxingv.smartrecyclerview.stickyheadersrecyclerview.rendering.HeaderRenderer;
import com.guoxiaoxingv.smartrecyclerview.stickyheadersrecyclerview.util.LinearLayoutOrientationProvider;
import com.guoxiaoxingv.smartrecyclerview.stickyheadersrecyclerview.util.OrientationProvider;

public class StickyRecyclerHeadersDecoration extends RecyclerView.ItemDecoration {

  private final com.guoxiaoxingv.smartrecyclerview.stickyheadersrecyclerview.StickyRecyclerHeadersAdapter mAdapter;
  private final SparseArray<Rect> mHeaderRects = new SparseArray<>();
  private final HeaderProvider mHeaderProvider;
  private final OrientationProvider mOrientationProvider;
  private final com.guoxiaoxingv.smartrecyclerview.stickyheadersrecyclerview.HeaderPositionCalculator mHeaderPositionCalculator;
  private final HeaderRenderer mRenderer;
  private final DimensionCalculator mDimensionCalculator;

  // TODO: Consider passing in orientation to simplify orientation accounting within calculation
  public StickyRecyclerHeadersDecoration(com.guoxiaoxingv.smartrecyclerview.stickyheadersrecyclerview.StickyRecyclerHeadersAdapter adapter) {
    this(adapter, new LinearLayoutOrientationProvider(), new DimensionCalculator());
  }

  private StickyRecyclerHeadersDecoration(com.guoxiaoxingv.smartrecyclerview.stickyheadersrecyclerview.StickyRecyclerHeadersAdapter adapter, OrientationProvider orientationProvider,
  ...
  private StickyRecyclerHeadersDecoration(com.guoxiaoxingv.smartrecyclerview.stickyheadersrecyclerview.StickyRecyclerHeadersAdapter adapter, OrientationProvider orientationProvider,
    ...
    this(adapter, headerRenderer, orientationProvider, dimensionCalculator, headerProvider,
        new com.guoxiaoxingv.smartrecyclerview.stickyheadersrecyclerview.HeaderPositionCalculator(adapter, headerProvider, orientationProvider,
            dimensionCalculator));
  }

  private StickyRecyclerHeadersDecoration(com.guoxiaoxingv.smartrecyclerview.stickyheadersrecyclerview.StickyRecyclerHeadersAdapter adapter, HeaderRenderer headerRenderer,
