package com.guoxiaoxingv.smartrecyclerview.stickyheader;
...
import com.guoxiaoxingv.smartrecyclerview.stickyheader.caching.HeaderProvider;
import com.guoxiaoxingv.smartrecyclerview.stickyheader.caching.HeaderViewCache;
import com.guoxiaoxingv.smartrecyclerview.stickyheader.calculation.DimensionCalculator;
import com.guoxiaoxingv.smartrecyclerview.stickyheader.rendering.HeaderRenderer;
import com.guoxiaoxingv.smartrecyclerview.stickyheader.util.LinearLayoutOrientationProvider;
import com.guoxiaoxingv.smartrecyclerview.stickyheader.util.OrientationProvider;

public class StickyRecyclerHeadersDecoration extends RecyclerView.ItemDecoration {

  private final com.guoxiaoxingv.smartrecyclerview.stickyheader.StickyRecyclerHeadersAdapter mAdapter;
  private final SparseArray<Rect> mHeaderRects = new SparseArray<>();
  private final HeaderProvider mHeaderProvider;
  private final OrientationProvider mOrientationProvider;
  private final com.guoxiaoxingv.smartrecyclerview.stickyheader.HeaderPositionCalculator mHeaderPositionCalculator;
  private final HeaderRenderer mRenderer;
  private final DimensionCalculator mDimensionCalculator;

  // TODO: Consider passing in orientation to simplify orientation accounting within calculation
  public StickyRecyclerHeadersDecoration(com.guoxiaoxingv.smartrecyclerview.stickyheader.StickyRecyclerHeadersAdapter adapter) {
    this(adapter, new LinearLayoutOrientationProvider(), new DimensionCalculator());
  }

  private StickyRecyclerHeadersDecoration(com.guoxiaoxingv.smartrecyclerview.stickyheader.StickyRecyclerHeadersAdapter adapter, OrientationProvider orientationProvider,
  ...
  private StickyRecyclerHeadersDecoration(com.guoxiaoxingv.smartrecyclerview.stickyheader.StickyRecyclerHeadersAdapter adapter, OrientationProvider orientationProvider,
    ...
    this(adapter, headerRenderer, orientationProvider, dimensionCalculator, headerProvider,
        new com.guoxiaoxingv.smartrecyclerview.stickyheader.HeaderPositionCalculator(adapter, headerProvider, orientationProvider,
            dimensionCalculator));
  }

  private StickyRecyclerHeadersDecoration(com.guoxiaoxingv.smartrecyclerview.stickyheader.StickyRecyclerHeadersAdapter adapter, HeaderRenderer headerRenderer,
